...
import FinalWork.Controller;
import FinalWork.Model.*;
import FinalWork.util.Counter;
...
public class View implements interfaceView {
    ...
    public void showKennelRegistry() {
        ...
        List<AbstractAnimal> animals = Controller.getAnimals();
    ...
    public boolean showAddAnimalDialog() {
        String infoMessage = "Введите параметры животного в виде строки: \"имя день_рождения род_животного\"\n" +
                "день_рождения имеет вид: dd-mm-yyyy (11-11-2011): \n" +
        ...
        while (true) {
            ...
            try (counter){
                ...
                counter.add();
                return Controller.createAnimal(parsedData.name, parsedData.birthDate, parsedData.animalGenius);
    ...
    public void showDetailInfoAnimalDialog() {
        ...
        while (true) {
            try {
                ...
                AbstractAnimal animal = Controller.getAnimals().get(animalNumber - 1);
